...
const ObjCopy_Alpha = (obj) => {return {...obj}} // не глубокое копирование(-вложеность)
const ObjCopy_Beta = (obj) => JSON.parse(JSON.stringify(obj)) // только базовые обьекты(-Date, Map, Set)
const ObjCopy_Gama = (obj) => structuredClone(obj) // полноценное
